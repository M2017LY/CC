...
class Company
{
     ...
     * @var string
     *
     * @ORM\Column(name="dfName", type="string", length=20)
     */
    private $dfName;
     ...
     * @var string
     *
     * @ORM\Column(name="dlName", type="string", length=30)
     */
    private $dlName;
     ...
     * @return Company
     */
    public function setDfName($dfName)
    {
        $this->dfName = $dfName;
     ...
     * @return Company
     */
    public function setDlName($dlName)
    {
        $this->dlName = $dlName;
